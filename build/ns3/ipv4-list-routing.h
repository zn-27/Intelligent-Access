 ...
 */
  virtual void SetRoutingProtocolPriority(uint32_t index, int16_t newPriority);
  /**
 ...
 */
  virtual bool SetRoutingProtocolPriorityByType(TypeId type, int16_t newPriority);
