...
typedef struct {
    PyObject_HEAD
    ns3::ParallelCommunicationInterface *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3ParallelCommunicationInterface;


extern PyTypeObject PyNs3ParallelCommunicationInterface_Type;

extern std::map<void*, PyObject*> PyNs3ParallelCommunicationInterface_wrapper_registry;
...
class PyNs3MpiReceiver__PythonHelper : public ns3::MpiReceiver
{
public:
    PyObject *m_pyself;
    PyNs3MpiReceiver__PythonHelper()
        : ns3::MpiReceiver(), m_pyself(NULL)
        {}

    PyNs3MpiReceiver__PythonHelper(ns3::MpiReceiver const & arg0)
        : ns3::MpiReceiver(arg0), m_pyself(NULL)
        {}
    ...
    virtual ~PyNs3MpiReceiver__PythonHelper()
    {
        Py_CLEAR(m_pyself);
    }


    static PyObject * _wrap_DoInitialize(PyNs3MpiReceiver *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs));
    inline void DoInitialize__parent_caller()
    { ns3::Object::DoInitialize(); }

    static PyObject * _wrap_NotifyNewAggregate(PyNs3MpiReceiver *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs));
    inline void NotifyNewAggregate__parent_caller()
    { ns3::Object::NotifyNewAggregate(); }

    static PyObject * _wrap_NotifyConstructionCompleted(PyNs3MpiReceiver *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs));
    ...
    {
      static ns3::TypeId tid = ns3::TypeId ("PyNs3MpiReceiver__PythonHelper")
        .SetParent< ns3::MpiReceiver > ()
        ;
      return tid;
    }
};

NS_OBJECT_ENSURE_REGISTERED (PyNs3MpiReceiver__PythonHelper);
