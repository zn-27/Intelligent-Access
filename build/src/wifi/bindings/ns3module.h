...
public:
    ...
    virtual ns3::AcIndex GetAccessCategory() const;
...
extern PyTypeObject PyNs3WifiMacQueueItemQueueIteratorPair_Type;

extern std::map<void*, PyObject*> PyNs3WifiMacQueueItemQueueIteratorPair_wrapper_registry;
...
public:
    ...
    inline void DequeueMpdu__parent_caller(ns3::Ptr< ns3::WifiMacQueueItem > mpdu)
    { ns3::HtFrameExchangeManager::DequeueMpdu(mpdu); }
