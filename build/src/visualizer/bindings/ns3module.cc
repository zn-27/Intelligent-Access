...
PyObject *
_wrap_PyNs3PyViz_GetNodesStatistics(PyNs3PyViz *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3PyViz_GetPacketDropSamples(PyNs3PyViz *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    ns3::PyViz::PacketDropSampleList retval;
    Pyns3__PyViz__PacketDropSampleList *py_ns3__PyViz__PacketDropSampleList;
    
    retval = self->obj->GetPacketDropSamples();
    py_ns3__PyViz__PacketDropSampleList = PyObject_New(Pyns3__PyViz__PacketDropSampleList, &Pyns3__PyViz__PacketDropSampleList_Type);
    py_ns3__PyViz__PacketDropSampleList->obj = new ns3::PyViz::PacketDropSampleList(retval);
    py_retval = Py_BuildValue((char *) "N", py_ns3__PyViz__PacketDropSampleList);
    return py_retval;
}


PyObject *
_wrap_PyNs3PyViz_GetPauseMessages(PyNs3PyViz *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3PyViz_GetTransmissionSamples(PyNs3PyViz *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    ns3::PyViz::TransmissionSampleList retval;
    Pyns3__PyViz__TransmissionSampleList *py_ns3__PyViz__TransmissionSampleList;
    
    retval = self->obj->GetTransmissionSamples();
    py_ns3__PyViz__TransmissionSampleList = PyObject_New(Pyns3__PyViz__TransmissionSampleList, &Pyns3__PyViz__TransmissionSampleList_Type);
    py_ns3__PyViz__TransmissionSampleList->obj = new ns3::PyViz::TransmissionSampleList(retval);
    py_retval = Py_BuildValue((char *) "N", py_ns3__PyViz__TransmissionSampleList);
    return py_retval;
}
...
static PyObject*
_wrap_PyNs3PyViz__copy__(PyNs3PyViz *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyMethodDef PyNs3PyViz_methods[] = {
    ...
    {(char *) "LineClipping", (PyCFunction) _wrap_PyNs3PyViz_LineClipping, METH_KEYWORDS|METH_STATIC|METH_VARARGS, "LineClipping(boundsX1, boundsY1, boundsX2, boundsY2, lineX1, lineY1, lineX2, lineY2)\n\ntype: boundsX1: double\ntype: boundsY1: double\ntype: boundsX2: double\ntype: boundsY2: double\ntype: lineX1: double &\ntype: lineY1: double &\ntype: lineX2: double &\ntype: lineY2: double &" },
    {(char *) "Pause", (PyCFunction) _wrap_PyNs3PyViz_Pause, METH_KEYWORDS|METH_STATIC|METH_VARARGS, "Pause(message)\n\ntype: message: std::string const &" },
...
static PyObject*
_wrap_PyNs3PyVizLastPacketsSample__copy__(PyNs3PyVizLastPacketsSample *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyObject*
_wrap_PyNs3PyVizNetDeviceStatistics__copy__(PyNs3PyVizNetDeviceStatistics *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyObject*
_wrap_PyNs3PyVizNodeStatistics__copy__(PyNs3PyVizNodeStatistics *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyObject*
_wrap_PyNs3PyVizPacketCaptureOptions__copy__(PyNs3PyVizPacketCaptureOptions *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyObject*
_wrap_PyNs3PyVizPacketDropSample__copy__(PyNs3PyVizPacketDropSample *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyObject*
_wrap_PyNs3PyVizPacketSample__copy__(PyNs3PyVizPacketSample *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyObject*
_wrap_PyNs3PyVizRxPacketSample__copy__(PyNs3PyVizRxPacketSample *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyObject*
_wrap_PyNs3PyVizTransmissionSample__copy__(PyNs3PyVizTransmissionSample *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyObject*
_wrap_PyNs3PyVizTxPacketSample__copy__(PyNs3PyVizTxPacketSample *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "visualizer.Std__map__lt___std__string__ns3__LogComponent___star_____gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__ns3__LogComponent___star_____gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "visualizer.Std__map__lt___std__string__ns3__LogComponent___star_____gt__Iter",            /* tp_name */
...
static void
Pyns3__PyViz__TransmissionSampleListIter__tp_clear(Pyns3__PyViz__TransmissionSampleListIter *self)
{
    Py_CLEAR(self->container);
    delete self->iterator;
    self->iterator = NULL;
...
static int
Pyns3__PyViz__TransmissionSampleListIter__tp_traverse(Pyns3__PyViz__TransmissionSampleListIter *self, visitproc visit, void *arg)
{
    Py_VISIT((PyObject *) self->container);
    return 0;
}
...
static void
_wrap_Pyns3__PyViz__TransmissionSampleList__tp_dealloc(Pyns3__PyViz__TransmissionSampleList *self)
{
    delete self->obj;
    self->obj = NULL;
...
static void
_wrap_Pyns3__PyViz__TransmissionSampleListIter__tp_dealloc(Pyns3__PyViz__TransmissionSampleListIter *self)
{
    Py_CLEAR(self->container);
    delete self->iterator;
    self->iterator = NULL;
...
static PyObject*
_wrap_Pyns3__PyViz__TransmissionSampleList__tp_iter(Pyns3__PyViz__TransmissionSampleList *self)
{
    Pyns3__PyViz__TransmissionSampleListIter *iter = PyObject_GC_New(Pyns3__PyViz__TransmissionSampleListIter, &Pyns3__PyViz__TransmissionSampleListIter_Type);
    Py_INCREF(self);
    iter->container = self;
    iter->iterator = new ns3::PyViz::TransmissionSampleList::iterator(self->obj->begin());
    return (PyObject*) iter;
}


static PyObject*
_wrap_Pyns3__PyViz__TransmissionSampleListIter__tp_iter(Pyns3__PyViz__TransmissionSampleListIter *self)
{
    Py_INCREF(self);
    return (PyObject*) self;
}

static PyObject* _wrap_Pyns3__PyViz__TransmissionSampleListIter__tp_iternext(Pyns3__PyViz__TransmissionSampleListIter *self)
{
    PyObject *py_retval;
    ns3::PyViz::TransmissionSampleList::iterator iter;
    PyNs3PyVizTransmissionSample *py_TransmissionSample;
...
int _wrap_convert_py2c__ns3__PyViz__TransmissionSampleList(PyObject *arg, ns3::PyViz::TransmissionSampleList *container)
{
    if (PyObject_IsInstance(arg, (PyObject*) &Pyns3__PyViz__TransmissionSampleList_Type)) {
        *container = *((Pyns3__PyViz__TransmissionSampleList*)arg)->obj;
    } else if (PyList_Check(arg)) {
        container->clear();
        Py_ssize_t size = PyList_Size(arg);
        for (Py_ssize_t i = 0; i < size; i++) {
        ...
        PyErr_SetString(PyExc_TypeError, "parameter must be None, a Ns3__PyViz__TransmissionSampleList instance, or a list of ns3::PyViz::TransmissionSample");
        return 0;
    }
    return 1;
}
...
static int
_wrap_Pyns3__PyViz__TransmissionSampleList__tp_init(Pyns3__PyViz__TransmissionSampleList *self, PyObject *args, PyObject *kwargs)
{
    const char *keywords[] = {"arg", NULL};
    PyObject *arg = NULL;
    ...
    self->obj = new ns3::PyViz::TransmissionSampleList;

    if (arg == NULL)
        return 0;

    if (!_wrap_convert_py2c__ns3__PyViz__TransmissionSampleList(arg, self->obj)) {
        delete self->obj;
        self->obj = NULL;
        return -1;
    }
...
PyTypeObject Pyns3__PyViz__TransmissionSampleList_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "visualizer.Ns3__PyViz__TransmissionSampleList",            /* tp_name */
    sizeof(Pyns3__PyViz__TransmissionSampleList),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_Pyns3__PyViz__TransmissionSampleList__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)_wrap_Pyns3__PyViz__TransmissionSampleList__tp_iter,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)NULL, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    NULL,                     /* tp_getset */
    ...
    (descrsetfunc)NULL,    /* tp_descr_set */
    0,                 /* tp_dictoffset */
    (initproc)_wrap_Pyns3__PyViz__TransmissionSampleList__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
PyTypeObject Pyns3__PyViz__TransmissionSampleListIter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "visualizer.Ns3__PyViz__TransmissionSampleListIter",            /* tp_name */
    sizeof(Pyns3__PyViz__TransmissionSampleListIter),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_Pyns3__PyViz__TransmissionSampleListIter__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_GC,                      /* tp_flags */
    NULL,                        /* Documentation string */
    (traverseproc)Pyns3__PyViz__TransmissionSampleListIter__tp_traverse,     /* tp_traverse */
    (inquiry)Pyns3__PyViz__TransmissionSampleListIter__tp_clear,             /* tp_clear */
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)_wrap_Pyns3__PyViz__TransmissionSampleListIter__tp_iter,          /* tp_iter */
    (iternextfunc)_wrap_Pyns3__PyViz__TransmissionSampleListIter__tp_iternext,     /* tp_iternext */
    (struct PyMethodDef*)NULL, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    NULL,                     /* tp_getset */
    NULL,                              /* tp_base */
...
static void
Pyns3__PyViz__PacketDropSampleListIter__tp_clear(Pyns3__PyViz__PacketDropSampleListIter *self)
{
    Py_CLEAR(self->container);
    delete self->iterator;
    self->iterator = NULL;
...
static int
Pyns3__PyViz__PacketDropSampleListIter__tp_traverse(Pyns3__PyViz__PacketDropSampleListIter *self, visitproc visit, void *arg)
{
    Py_VISIT((PyObject *) self->container);
    return 0;
}
...
static void
_wrap_Pyns3__PyViz__PacketDropSampleList__tp_dealloc(Pyns3__PyViz__PacketDropSampleList *self)
{
    delete self->obj;
    self->obj = NULL;
...
static void
_wrap_Pyns3__PyViz__PacketDropSampleListIter__tp_dealloc(Pyns3__PyViz__PacketDropSampleListIter *self)
{
    Py_CLEAR(self->container);
    delete self->iterator;
    self->iterator = NULL;
...
static PyObject*
_wrap_Pyns3__PyViz__PacketDropSampleList__tp_iter(Pyns3__PyViz__PacketDropSampleList *self)
{
    Pyns3__PyViz__PacketDropSampleListIter *iter = PyObject_GC_New(Pyns3__PyViz__PacketDropSampleListIter, &Pyns3__PyViz__PacketDropSampleListIter_Type);
    Py_INCREF(self);
    iter->container = self;
    iter->iterator = new ns3::PyViz::PacketDropSampleList::iterator(self->obj->begin());
    return (PyObject*) iter;
}


static PyObject*
_wrap_Pyns3__PyViz__PacketDropSampleListIter__tp_iter(Pyns3__PyViz__PacketDropSampleListIter *self)
{
    Py_INCREF(self);
    return (PyObject*) self;
}

static PyObject* _wrap_Pyns3__PyViz__PacketDropSampleListIter__tp_iternext(Pyns3__PyViz__PacketDropSampleListIter *self)
{
    PyObject *py_retval;
    ns3::PyViz::PacketDropSampleList::iterator iter;
    PyNs3PyVizPacketDropSample *py_PacketDropSample;
...
int _wrap_convert_py2c__ns3__PyViz__PacketDropSampleList(PyObject *arg, ns3::PyViz::PacketDropSampleList *container)
{
    if (PyObject_IsInstance(arg, (PyObject*) &Pyns3__PyViz__PacketDropSampleList_Type)) {
        *container = *((Pyns3__PyViz__PacketDropSampleList*)arg)->obj;
    } else if (PyList_Check(arg)) {
        container->clear();
        Py_ssize_t size = PyList_Size(arg);
        for (Py_ssize_t i = 0; i < size; i++) {
        ...
        PyErr_SetString(PyExc_TypeError, "parameter must be None, a Ns3__PyViz__PacketDropSampleList instance, or a list of ns3::PyViz::PacketDropSample");
        return 0;
    }
    return 1;
}
...
static int
_wrap_Pyns3__PyViz__PacketDropSampleList__tp_init(Pyns3__PyViz__PacketDropSampleList *self, PyObject *args, PyObject *kwargs)
{
    const char *keywords[] = {"arg", NULL};
    PyObject *arg = NULL;
    ...
    self->obj = new ns3::PyViz::PacketDropSampleList;

    if (arg == NULL)
        return 0;

    if (!_wrap_convert_py2c__ns3__PyViz__PacketDropSampleList(arg, self->obj)) {
        delete self->obj;
        self->obj = NULL;
        return -1;
    }
...
PyTypeObject Pyns3__PyViz__PacketDropSampleList_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "visualizer.Ns3__PyViz__PacketDropSampleList",            /* tp_name */
    sizeof(Pyns3__PyViz__PacketDropSampleList),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_Pyns3__PyViz__PacketDropSampleList__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)_wrap_Pyns3__PyViz__PacketDropSampleList__tp_iter,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)NULL, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    NULL,                     /* tp_getset */
    ...
    (descrsetfunc)NULL,    /* tp_descr_set */
    0,                 /* tp_dictoffset */
    (initproc)_wrap_Pyns3__PyViz__PacketDropSampleList__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
PyTypeObject Pyns3__PyViz__PacketDropSampleListIter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "visualizer.Ns3__PyViz__PacketDropSampleListIter",            /* tp_name */
    sizeof(Pyns3__PyViz__PacketDropSampleListIter),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_Pyns3__PyViz__PacketDropSampleListIter__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
#if PY_MAJOR_VERSION >= 3
    ...
    Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_GC,                      /* tp_flags */
    NULL,                        /* Documentation string */
    (traverseproc)Pyns3__PyViz__PacketDropSampleListIter__tp_traverse,     /* tp_traverse */
    (inquiry)Pyns3__PyViz__PacketDropSampleListIter__tp_clear,             /* tp_clear */
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)_wrap_Pyns3__PyViz__PacketDropSampleListIter__tp_iter,          /* tp_iter */
    (iternextfunc)_wrap_Pyns3__PyViz__PacketDropSampleListIter__tp_iternext,     /* tp_iternext */
    (struct PyMethodDef*)NULL, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    NULL,                     /* tp_getset */
    NULL,                              /* tp_base */
...
MOD_INIT(visualizer)
{
    ...
    /* Register the 'ns3::PyViz::TransmissionSampleList' class */
    if (PyType_Ready(&Pyns3__PyViz__TransmissionSampleList_Type)) {
        return MOD_ERROR;
    }
    if (PyType_Ready(&Pyns3__PyViz__TransmissionSampleListIter_Type)) {
        return MOD_ERROR;
    }
    PyModule_AddObject(m, (char *) "Ns3__PyViz__TransmissionSampleList", (PyObject *) &Pyns3__PyViz__TransmissionSampleList_Type);
    PyModule_AddObject(m, (char *) "Ns3__PyViz__TransmissionSampleListIter", (PyObject *) &Pyns3__PyViz__TransmissionSampleListIter_Type);
    ...
    /* Register the 'ns3::PyViz::PacketDropSampleList' class */
    if (PyType_Ready(&Pyns3__PyViz__PacketDropSampleList_Type)) {
        return MOD_ERROR;
    }
    if (PyType_Ready(&Pyns3__PyViz__PacketDropSampleListIter_Type)) {
        return MOD_ERROR;
    }
    PyModule_AddObject(m, (char *) "Ns3__PyViz__PacketDropSampleList", (PyObject *) &Pyns3__PyViz__PacketDropSampleList_Type);
    PyModule_AddObject(m, (char *) "Ns3__PyViz__PacketDropSampleListIter", (PyObject *) &Pyns3__PyViz__PacketDropSampleListIter_Type);
