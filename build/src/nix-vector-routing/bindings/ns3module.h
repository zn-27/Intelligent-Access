...
class PyNs3Ipv4NixVectorHelper__PythonHelper : public ns3::Ipv4NixVectorHelper
{
public:
    PyObject *m_pyself;
    PyNs3Ipv4NixVectorHelper__PythonHelper()
        : ns3::Ipv4NixVectorHelper(), m_pyself(NULL)
        {}

    PyNs3Ipv4NixVectorHelper__PythonHelper(ns3::Ipv4NixVectorHelper const & o)
        : ns3::Ipv4NixVectorHelper(o), m_pyself(NULL)
        {}
    ...
    virtual ~PyNs3Ipv4NixVectorHelper__PythonHelper()
    {
        Py_CLEAR(m_pyself);
    }


    virtual ns3::Ipv4NixVectorHelper * Copy() const;
