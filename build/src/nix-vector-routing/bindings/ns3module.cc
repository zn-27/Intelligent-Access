...
PyNs3Ipv4NixVectorHelper__PythonHelper::Copy() const
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::Ipv4NixVectorHelper *self_obj_before;
    PyObject *py_retval;
    ns3::Ipv4NixVectorHelper *retval;
    PyNs3Ipv4NixVectorHelper *tmp_Ipv4NixVectorHelper;
    ...
    if (py_method == NULL || Py_TYPE(py_method) == &PyCFunction_Type) {
        ...
        return ns3::Ipv4NixVectorHelper::Copy();
    }
    self_obj_before = reinterpret_cast< PyNs3Ipv4NixVectorHelper* >(m_pyself)->obj;
    reinterpret_cast< PyNs3Ipv4NixVectorHelper* >(m_pyself)->obj = const_cast< ns3::Ipv4NixVectorHelper* >((const ns3::Ipv4NixVectorHelper*) this);
    py_retval = PyObject_CallMethod(m_pyself, (char *) "Copy", (char *) "");
    if (py_retval == NULL) {
        PyErr_Print();
        reinterpret_cast< PyNs3Ipv4NixVectorHelper* >(m_pyself)->obj = self_obj_before;
        Py_XDECREF(py_method);
        if (PyEval_ThreadsInitialized())
            PyGILState_Release(__py_gil_state);
        return ns3::Ipv4NixVectorHelper::Copy();
    ...
    if (!PyArg_ParseTuple(py_retval, (char *) "O!", &PyNs3Ipv4NixVectorHelper_Type, &tmp_Ipv4NixVectorHelper)) {
        PyErr_Print();
        Py_DECREF(py_retval);
        reinterpret_cast< PyNs3Ipv4NixVectorHelper* >(m_pyself)->obj = self_obj_before;
        Py_XDECREF(py_method);
    ...
    // dangerous!
    retval = tmp_Ipv4NixVectorHelper->obj;
    Py_DECREF(py_retval);
    reinterpret_cast< PyNs3Ipv4NixVectorHelper* >(m_pyself)->obj = self_obj_before;
    Py_XDECREF(py_method);
    if (PyEval_ThreadsInitialized())
...
PyNs3Ipv4NixVectorHelper__PythonHelper::Create(ns3::Ptr< ns3::Node > node) const
{
    PyGILState_STATE __py_gil_state;
    PyObject *py_method;
    ns3::Ipv4NixVectorHelper *self_obj_before;
    ...
    if (py_method == NULL || Py_TYPE(py_method) == &PyCFunction_Type) {
        ...
        if (PyEval_ThreadsInitialized())
            PyGILState_Release(__py_gil_state);
        return ns3::Ipv4NixVectorHelper::Create(node);
    }
    self_obj_before = reinterpret_cast< PyNs3Ipv4NixVectorHelper* >(m_pyself)->obj;
    reinterpret_cast< PyNs3Ipv4NixVectorHelper* >(m_pyself)->obj = const_cast< ns3::Ipv4NixVectorHelper* >((const ns3::Ipv4NixVectorHelper*) this);
...
_wrap_PyNs3Ipv4NixVectorHelper__tp_init__0(PyNs3Ipv4NixVectorHelper *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    ...
    if (Py_TYPE(self) != &PyNs3Ipv4NixVectorHelper_Type)
    {
        self->obj = new PyNs3Ipv4NixVectorHelper__PythonHelper();
        self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
        ((PyNs3Ipv4NixVectorHelper__PythonHelper*) self->obj)->set_pyobj((PyObject *)self);
    } else {
        // visibility: 'public'
...
{
    PyNs3Ipv4NixVectorHelper *o;
    const char *keywords[] = {"o", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "O!", (char **) keywords, &PyNs3Ipv4NixVectorHelper_Type, &o)) {
        {
            PyObject *exc_type, *traceback;
            PyErr_Fetch(&exc_type, return_exception, &traceback);
            Py_XDECREF(exc_type);
    ...
    if (Py_TYPE(self) != &PyNs3Ipv4NixVectorHelper_Type)
    {
        self->obj = new PyNs3Ipv4NixVectorHelper__PythonHelper(*((PyNs3Ipv4NixVectorHelper *) o)->obj);
        self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
        ((PyNs3Ipv4NixVectorHelper__PythonHelper*) self->obj)->set_pyobj((PyObject *)self);
    } else {
        // visibility: 'public'
        self->obj = new ns3::Ipv4NixVectorHelper(*((PyNs3Ipv4NixVectorHelper *) o)->obj);
        self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    }
    return 0;
}
...
PyObject *
_wrap_PyNs3Ipv4NixVectorHelper_Copy(PyNs3Ipv4NixVectorHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    ns3::Ipv4NixVectorHelper *retval;
    PyNs3Ipv4NixVectorHelper__PythonHelper *helper_class = dynamic_cast<PyNs3Ipv4NixVectorHelper__PythonHelper*> (self->obj);
    PyNs3Ipv4NixVectorHelper *py_Ipv4NixVectorHelper;
    std::map<void*, PyObject*>::const_iterator wrapper_lookup_iter;
    
    retval = (helper_class == NULL)? (self->obj->Copy()) : (self->obj->ns3::Ipv4NixVectorHelper::Copy());
    if (!(retval)) {
        Py_INCREF(Py_None);
        return Py_None;
    }
    if (typeid((*retval)).name() == typeid(PyNs3Ipv4NixVectorHelper__PythonHelper).name())
    {
        py_Ipv4NixVectorHelper = reinterpret_cast< PyNs3Ipv4NixVectorHelper* >(reinterpret_cast< PyNs3Ipv4NixVectorHelper__PythonHelper* >(retval)->m_pyself);
        py_Ipv4NixVectorHelper->obj = retval;
        Py_INCREF(py_Ipv4NixVectorHelper);
    } else {
        ...
        if (wrapper_lookup_iter == PyNs3Ipv4RoutingHelper_wrapper_registry.end()) {
            py_Ipv4NixVectorHelper = NULL;
        } else {
            py_Ipv4NixVectorHelper = (PyNs3Ipv4NixVectorHelper *) wrapper_lookup_iter->second;
            Py_INCREF(py_Ipv4NixVectorHelper);
        }
    
        if (py_Ipv4NixVectorHelper == NULL) {
            py_Ipv4NixVectorHelper = PyObject_GC_New(PyNs3Ipv4NixVectorHelper, &PyNs3Ipv4NixVectorHelper_Type);
            py_Ipv4NixVectorHelper->inst_dict = NULL;
            py_Ipv4NixVectorHelper->inst_dict = NULL;
            py_Ipv4NixVectorHelper->obj = new ns3::Ipv4NixVectorHelper((*retval));
            py_Ipv4NixVectorHelper->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
            PyNs3Ipv4RoutingHelper_wrapper_registry[(void *) py_Ipv4NixVectorHelper->obj] = (PyObject *) py_Ipv4NixVectorHelper;
        }
    }
    py_retval = Py_BuildValue((char *) "N", py_Ipv4NixVectorHelper);
    return py_retval;
}
...
_wrap_PyNs3Ipv4NixVectorHelper_Create(PyNs3Ipv4NixVectorHelper *self, PyObject *args, PyObject *kwargs)
{
    ...
    retval = (helper_class == NULL)? (self->obj->Create(ns3::Ptr< ns3::Node  > (node_ptr))) : (self->obj->ns3::Ipv4NixVectorHelper::Create(ns3::Ptr< ns3::Node  > (node_ptr)));
...
PyObject *
_wrap_PyNs3Ipv4NixVectorHelper_PrintRoutingPathAt(PyNs3Ipv4NixVectorHelper *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyNs3Time *printTime;
    PyNs3Node *source;
    ...
    const char *keywords[] = {"printTime", "source", "dest", "stream", "unit", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "O!O!O!O!|i", (char **) keywords, &PyNs3Time_Type, &printTime, &PyNs3Node_Type, &source, &PyNs3Ipv4Address_Type, &dest, &PyNs3OutputStreamWrapper_Type, &stream, &unit)) {
        return NULL;
    }
    source_ptr = (source ? source->obj : NULL);
    stream_ptr = (stream ? stream->obj : NULL);
    self->obj->PrintRoutingPathAt(*((PyNs3Time *) printTime)->obj, ns3::Ptr< ns3::Node  > (source_ptr), *((PyNs3Ipv4Address *) dest)->obj, ns3::Ptr< ns3::OutputStreamWrapper  > (stream_ptr), unit);
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static PyObject*
_wrap_PyNs3Ipv4NixVectorHelper__copy__(PyNs3Ipv4NixVectorHelper *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyMethodDef PyNs3Ipv4NixVectorHelper_methods[] = {
    {(char *) "Copy", (PyCFunction) _wrap_PyNs3Ipv4NixVectorHelper_Copy, METH_NOARGS, "Copy()\n\n" },
    ...
    {(char *) "PrintRoutingPathAt", (PyCFunction) _wrap_PyNs3Ipv4NixVectorHelper_PrintRoutingPathAt, METH_KEYWORDS|METH_VARARGS, "PrintRoutingPathAt(printTime, source, dest, stream, unit)\n\ntype: printTime: ns3::Time\ntype: source: ns3::Ptr< ns3::Node >\ntype: dest: ns3::Ipv4Address\ntype: stream: ns3::Ptr< ns3::OutputStreamWrapper >\ntype: unit: ns3::Time::Unit" },
...
PyNs3Ipv4NixVectorHelper__tp_traverse(PyNs3Ipv4NixVectorHelper *self, visitproc visit, void *arg)
{
    ...
    if (self->obj && typeid(*self->obj).name() == typeid(PyNs3Ipv4NixVectorHelper__PythonHelper).name() )
...
PyObject *
_wrap_PyNs3Ipv4NixVectorRouting_FlushGlobalNixRoutingCache(PyNs3Ipv4NixVectorRouting *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3Ipv4NixVectorRouting_GetTypeId(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3Ipv4NixVectorRouting_PrintRoutingPath(PyNs3Ipv4NixVectorRouting *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyNs3Node *source;
    ns3::Node *source_ptr;
    ...
    ns3::OutputStreamWrapper *stream_ptr;
    ns3::Time::Unit unit;
    const char *keywords[] = {"source", "dest", "stream", "unit", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "O!O!O!i", (char **) keywords, &PyNs3Node_Type, &source, &PyNs3Ipv4Address_Type, &dest, &PyNs3OutputStreamWrapper_Type, &stream, &unit)) {
        return NULL;
    }
    source_ptr = (source ? source->obj : NULL);
    stream_ptr = (stream ? stream->obj : NULL);
    self->obj->PrintRoutingPath(ns3::Ptr< ns3::Node  > (source_ptr), *((PyNs3Ipv4Address *) dest)->obj, ns3::Ptr< ns3::OutputStreamWrapper  > (stream_ptr), unit);
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static PyObject*
_wrap_PyNs3Ipv4NixVectorRouting__copy__(PyNs3Ipv4NixVectorRouting *self, PyObject *PYBINDGEN_UNUSED(_args))
{
...
static PyMethodDef PyNs3Ipv4NixVectorRouting_methods[] = {
    ...
    {(char *) "PrintRoutingPath", (PyCFunction) _wrap_PyNs3Ipv4NixVectorRouting_PrintRoutingPath, METH_KEYWORDS|METH_VARARGS, "PrintRoutingPath(source, dest, stream, unit)\n\ntype: source: ns3::Ptr< ns3::Node >\ntype: dest: ns3::Ipv4Address\ntype: stream: ns3::Ptr< ns3::OutputStreamWrapper >\ntype: unit: ns3::Time::Unit" },
