...
{
public:
  AodvRegressionTestSuite () : TestSuite ("routing-smartAodv-regression", SYSTEM)
  {
    SetDataDir (NS_TEST_SOURCEDIR);
    // General RREQ-RREP-RRER test case
    AddTestCase (new ChainRegressionTest ("smartAodv-chain-regression-test"), TestCase::QUICK);
...
ChainRegressionTest::CreateDevices ()
{
  ...
  // 2. Setup TCP/IP & AODV
  SmartAodvV2Helper smartAodv; // Use default parameters here
  InternetStackHelper internetStack;
  internetStack.SetRoutingHelper (smartAodv);
  ...
  streamsUsed += smartAodv.AssignStreams (*m_nodes, streamsUsed);
