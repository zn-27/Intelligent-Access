...
#ifndef SMART_AODV_V2_HELPER_H
#define SMART_AODV_V2_HELPER_H
 ...
 */
class SmartAodvV2Helper : public Ipv4RoutingHelper
{
public:
  SmartAodvV2Helper ();

  /**
   * \returns pointer to clone of this SmartAodvV2Helper
   *
   * \internal
