...
#include "smart-aodv-v2-routing-protocol.h"
#include "ns3/log.h"
...
namespace ns3
{
  ...
  NS_LOG_COMPONENT_DEFINE("SmartAodvV2RoutingProtocol");
  ...
  namespace smartAodvV2
  {
    ...
    public:
      ...
      {
        static TypeId tid = TypeId("ns3::smartAodvV2::DeferredRouteOutputTag")
                                .SetParent<Tag>()
                                .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvV2::RoutingProtocol")
