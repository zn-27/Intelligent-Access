...
namespace ns3
{
  namespace smartAodvV2
  {
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvV2::TypeHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvV2::RreqHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvV2::RrepHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvV2::RrepAckHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvV2::RerrHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
