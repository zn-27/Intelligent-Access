 ...
 */
#include "smart-aodv-qlearning-packet.h"
...
namespace ns3
{
  namespace smartAodvQlearning
  {
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvQlearning::TypeHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    RreqHeader::RreqHeader(uint8_t flags, uint8_t reserved, uint8_t hopCount, uint32_t requestID, Ipv4Address dst,
        ...
        : m_flags(flags),
          ...
          m_minSnr(0.0) // SmartAodv: Initialize SNR to 0 dB
    {
    }
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvQlearning::RreqHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      return 31; // SmartAodv: Add 8 bytes for double-precision SNR field
    }
    ...
    RreqHeader::Serialize(Buffer::Iterator i) const
    {
      ...
      // SmartAodv: Serialize SNR field (8 bytes, network byte order)
      double snr = m_minSnr;
      uint64_t snrRaw;
    ...
    RreqHeader::Deserialize(Buffer::Iterator start)
    {
      ...
      // SmartAodv: Deserialize SNR field
    ...
    {
      return (m_flags == o.m_flags && m_reserved == o.m_reserved && m_hopCount == o.m_hopCount && m_requestID == o.m_requestID && m_dst == o.m_dst && m_dstSeqNo == o.m_dstSeqNo && m_origin == o.m_origin && m_originSeqNo == o.m_originSeqNo && m_minSnr == o.m_minSnr);
    }
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvQlearning::RrepHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      return (m_flags == o.m_flags && m_prefixSize == o.m_prefixSize && m_hopCount == o.m_hopCount && m_dst == o.m_dst && m_dstSeqNo == o.m_dstSeqNo && m_origin == o.m_origin && m_lifeTime == o.m_lifeTime);
    }
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvQlearning::RrepAckHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvQlearning::RerrHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
