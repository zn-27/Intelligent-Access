 ...
 */
#ifndef SMART_AODV_RTABLE_H
#define SMART_AODV_RTABLE_H
...
public:
  ...
  // SmartAodv: Link quality metrics for intelligent routing
  /**
   * Set the last RSSI value received from this route
  ...
  /**
   * Set the minimum SNR along the path
  ...
  /**
   * Get the minimum SNR along the path
  ...
  /**
   * Set the link expiry time (predicted link lifetime)
...
private:
  ...
  */
  ...
  // SmartAodv: Link quality metrics
  /// Last received RSSI value from this route (dBm)
  double m_lastRssi;
  /// Minimum SNR along the path (dB)
  double m_minSnr;
