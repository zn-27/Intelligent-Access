 ...
 */
#include "smart-aodv-cluster-packet.h"
...
namespace ns3
{
  namespace smartAodvCluster
  {
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvCluster::TypeHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvCluster::RreqHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvCluster::RrepHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvCluster::RrepAckHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvCluster::RerrHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
