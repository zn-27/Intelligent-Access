...
#include "smart-aodv-cluster-routing-protocol.h"
#include "ns3/log.h"
...
namespace ns3
{
  ...
  NS_LOG_COMPONENT_DEFINE("SmartAodvClusterRoutingProtocol");

  namespace smartAodvCluster
  {
    ...
    public:
      ...
      {
        static TypeId tid = TypeId("ns3::smartAodvCluster::DeferredRouteOutputTag")
                                .SetParent<Tag>()
                                .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodvCluster::RoutingProtocol")
