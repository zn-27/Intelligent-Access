 ...
 */
#ifndef HARP_RQUEUE_H
#define HARP_RQUEUE_H
...
/**
 * \ingroup harp
 * \brief HARP route request queue
 *
 * Since HARP is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
