...
#ifndef SMART_AODV_HELPER_H
#define SMART_AODV_HELPER_H
 ...
 */
class SmartAodvHelper : public Ipv4RoutingHelper
{
public:
  SmartAodvHelper ();

  /**
   * \returns pointer to clone of this SmartAodvHelper
   *
   * \internal
