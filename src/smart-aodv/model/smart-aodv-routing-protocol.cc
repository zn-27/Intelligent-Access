...
#include "smart-aodv-routing-protocol.h"
#include "ns3/log.h"
...
namespace ns3
{
  ...
  NS_LOG_COMPONENT_DEFINE("SmartAodvRoutingProtocol");
  ...
  namespace smartAodv
  {
    ...
    public:
      ...
      {
        static TypeId tid = TypeId("ns3::smartAodv::DeferredRouteOutputTag")
                                .SetParent<Tag>()
                                .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodv::RoutingProtocol")
