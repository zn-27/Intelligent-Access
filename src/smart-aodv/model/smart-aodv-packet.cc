...
namespace ns3
{
  namespace smartAodv
  {
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodv::TypeHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodv::RreqHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodv::RrepHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodv::RrepAckHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
    ...
    {
      static TypeId tid = TypeId("ns3::smartAodv::RerrHeader")
                              .SetParent<Header>()
                              .SetGroupName("Aodv")
